...
<div class="card">
    ...
    <form method="post" action="${pageContext.request.contextPath}/staff/update-car">
        ...
        <div class="text-center mt-4">
            ...
            <a href="${pageContext.request.contextPath}/staff/dashboard" class="btn btn-secondary px-3">Hủy</a>
        </div>
    </form>
</div>
<script>
