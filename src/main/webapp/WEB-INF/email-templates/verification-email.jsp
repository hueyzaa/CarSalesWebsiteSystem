            ...
            <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #1c1c1c; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 32px rgba(0,0,0,0.4);">
                    ...
                    <td style="background: #1c1c1c; padding: 48px 40px 36px; text-align: center;">
                        <div style="width: 72px; height: 72px; background: linear-gradient(135deg, #ffd700 0%, #ffed4e 100%); border-radius: 50%; margin: 0 auto 24px; display: inline-flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(255, 215, 0, 0.25);">
                            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 7L12 3L4 7M20 7L12 11M20 7V17L12 21M12 11L4 7M12 11V21M4 7V17L12 21" stroke="#1a1a1a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                ...
                <tr>
                    <td style="padding: 0 40px 48px;">
                        ...
                        <p style="margin: 0 0 20px; color: #d1d1d1; font-size: 15px; line-height: 1.7;">
                        ...
                        <div style="background: rgba(255, 215, 0, 0.08); border-left: 3px solid #ffd700; border-radius: 6px; padding: 16px 20px; margin: 24px 0;">
                            <p style="margin: 0; color: #e0e0e0; font-size: 14px; line-height: 1.6;">
                                <strong style="color: #ffd700;">⏰ Thời hạn:</strong> Link này có hiệu lực trong <strong>${tokenExpiryHours} giờ</strong>. Sau đó bạn cần yêu cầu gửi lại email xác thực.
                            </p>
                        </div>

                        <!-- Security Notice -->
                        <div style="background: rgba(239, 68, 68, 0.08); border-left: 3px solid #ef4444; border-radius: 6px; padding: 16px 20px; margin: 24px 0;">
                            <p style="margin: 0; color: #fca5a5; font-size: 13px; line-height: 1.6;">
                                <strong style="color: #ef4444;">🔒 Bảo mật:</strong> Nếu bạn không thực hiện đăng ký này, vui lòng bỏ qua email hoặc liên hệ với chúng tôi ngay.
                            </p>
                        </div>
                    </td>
                </tr>
