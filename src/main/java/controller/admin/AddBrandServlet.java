...
public class AddBrandServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String brandCountry = ValidationUtil.validateBrand(request.getParameter("brandLegion"));
            Brand br = new Brand();
            br.setBrandId(brandId);
            br.setBrandName(brandName);
            br.setBrandCountry(br.getBrandCountry());
    ...
    private void handleError(HttpServletRequest request, HttpServletResponse response, String errorMessage)
        ...
        request.setAttribute("brandCountry", request.getParameter("brandCountry"));
